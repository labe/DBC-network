var sharedSignupInfo = ("<form accept-charset='UTF-8' action='/mentors' method='post'><div style='margin:0;padding:0;display:inline'><input name='utf8' type='hidden' value='&#x2713;' /> \
...
var alumniSignup = ("<span>Student Signup</span>"+sharedSignupInfo+" \
...
var mentorSignup = ("<span>Mentor Signup</span>"+sharedSignupInfo+" \
  <br><input id='user_company_name' name='user[company_name]' placeholder='Company Name' size='30' type='text' /> \
  "+sharedOptionalInfo+" \
  <br><input name='commit' type='submit' value='Signup' /> \
  </form>")

var staffSignup = ("<span>Staff Signup</span>"+sharedSignupInfo+" \
  <br><input id='user_company_name' name='user[company_name]' placeholder='Company Name' size='30' type='text' /> \
  "+sharedOptionalInfo+" \
  <br><input name='commit' type='submit' value='Signup' /> \
  </form>")

var employerSignup = ("<span>Employer Signup</span>"+sharedSignupInfo+" \
  <br><select id='user_groupable_id' name='user[groupable_id]'><option value='>Please select</option> \
...
function overlay(whichSignup) {
	...
	$("body").append("<div id='overlay'><div id='box'><button class='close' id='popup'>Close</button></div></div>");
